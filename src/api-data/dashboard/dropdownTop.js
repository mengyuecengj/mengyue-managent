...
const decorationItemsRaw = getOriginalDecorationItems((key) => key);
// ==================== 工具函数 ====================
const transformToCascaderOptions = (items) => {
