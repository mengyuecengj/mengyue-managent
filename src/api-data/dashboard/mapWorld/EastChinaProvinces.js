...
import shanghaiMapData from '~/geo-coordinate/310000.json';
import jiangsuMapData from '~/geo-coordinate/320000.json';
import zhejiangMapData from '~/geo-coordinate/330000.json';
import anhuiMapData from '~/geo-coordinate/340000.json';
import fujianMapData from '~/geo-coordinate/350000.json';
import jiangxiMapData from '~/geo-coordinate/360000.json';
import shandongMapData from '~/geo-coordinate/370000.json';
import taiwanMapData from '~/geo-coordinate/710000.json';
// 注册华东地区地图数据
if (typeof window !== 'undefined') {
    window.echarts = echarts;
    echarts.registerMap('shanghai', shanghaiMapData);
    echarts.registerMap('jiangsu', jiangsuMapData);
    echarts.registerMap('zhejiang', zhejiangMapData);
    echarts.registerMap('anhui', anhuiMapData);
    echarts.registerMap('fujian', fujianMapData);
    echarts.registerMap('jiangxi', jiangxiMapData);
...
// 上海 (adcode: 310000)
export const shanghaiDistrictGeoCoordMap = {
...
export const convertShanghaiGeoData = () => shanghaiDistrictPopulationData
    .map(item => {
...
// 江苏 (adcode: 320000)
export const jiangsuDistrictGeoCoordMap = {
...
export const convertJiangsuGeoData = () => jiangsuDistrictPopulationData
    .map(item => {
...
// 浙江 (adcode: 330000)
export const zhejiangDistrictGeoCoordMap = {
...
export const convertZhejiangGeoData = () => zhejiangDistrictPopulationData
    .map(item => {
...
// 安徽 (adcode: 340000)
export const anhuiDistrictGeoCoordMap = {
...
export const convertAnhuiGeoData = () => anhuiDistrictPopulationData
    .map(item => {
...
// 福建 (adcode: 350000)
export const fujianDistrictGeoCoordMap = {
...
export const convertFujianGeoData = () => fujianDistrictPopulationData
    .map(item => {
...
// 江西 (adcode: 360000)
export const jiangxiDistrictGeoCoordMap = {
...
export const convertJiangxiGeoData = () => jiangxiDistrictPopulationData
    .map(item => {
...
// 山东 (adcode: 370000)
export const shandongDistrictGeoCoordMap = {
...
export const convertShandongGeoData = () => shandongDistrictPopulationData
    .map(item => {
...
// 台湾 (adcode: 710000)
export const taiwanDistrictGeoCoordMap = {
...
export const convertTaiwanGeoData = () => taiwanDistrictPopulationData
    .map(item => {
