...
import beijingMapData from '~/geo-coordinate/110000.json';
import tianjinMapData from '~/geo-coordinate/120000.json';
import hebeiMapData from '~/geo-coordinate/130000.json';
import shanxiMapData from '~/geo-coordinate/140000.json';
import neimengguMapData from '~/geo-coordinate/150000.json';
import liaoningMapData from '~/geo-coordinate/210000.json';
import jilinMapData from '~/geo-coordinate/220000.json';
import heilongjiangMapData from '~/geo-coordinate/230000.json';
// 注册华北地区地图数据
if (typeof window !== 'undefined') {
    window.echarts = echarts;
    echarts.registerMap('beijing', beijingMapData);
    echarts.registerMap('tianjin', tianjinMapData);
    echarts.registerMap('hebei', hebeiMapData);
    echarts.registerMap('shanxi', shanxiMapData);
    echarts.registerMap('neimenggu', neimengguMapData);
    echarts.registerMap('liaoning', liaoningMapData);
    echarts.registerMap('jilin', jilinMapData);
    echarts.registerMap('heilongjiang', heilongjiangMapData);
}
export var MapType;
(function (MapType) {
    MapType["Map_Province"] = "map-province";
})(MapType || (MapType = {}));
// 北京 (adcode: 110000)
export const beijingDistrictGeoCoordMap = {
...
export const convertBeijingGeoData = () => beijingDistrictPopulationData
    .map(item => {
...
// 天津 (adcode: 120000)
export const tianjinDistrictGeoCoordMap = {
...
export const convertTianjinGeoData = () => tianjinDistrictPopulationData
    .map(item => {
...
// 河北 (adcode: 130000)
export const hebeiDistrictGeoCoordMap = {
...
export const convertHebeiGeoData = () => hebeiDistrictPopulationData
    .map(item => {
...
// 山西 (adcode: 140000)
export const shanxiDistrictGeoCoordMap = {
...
export const convertShanxiGeoData = () => shanxiDistrictPopulationData
    .map(item => {
...
// 内蒙古 (adcode: 150000)
export const neimengguDistrictGeoCoordMap = {
...
export const convertNeimengguGeoData = () => neimengguDistrictPopulationData
    .map(item => {
...
// 辽宁 (adcode: 210000)
export const liaoningDistrictGeoCoordMap = {
...
export const convertLiaoningGeoData = () => liaoningDistrictPopulationData
    .map(item => {
...
// 吉林 (adcode: 220000)
export const jilinDistrictGeoCoordMap = {
...
export const convertJilinGeoData = () => jilinDistrictPopulationData
    .map(item => {
...
// 黑龙江 (adcode: 230000)
export const heilongjiangDistrictGeoCoordMap = {
...
export const convertHeilongjiangGeoData = () => heilongjiangDistrictPopulationData
    .map(item => {
