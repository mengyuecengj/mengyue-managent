...
import xianMapData from '~/geo-coordinate/610000.json';
import gansuMapData from '~/geo-coordinate/620000.json';
import qinghaiMapData from '~/geo-coordinate/630000.json';
import ningxiaMapData from '~/geo-coordinate/640000.json';
import xinjiangMapData from '~/geo-coordinate/650000.json';
// 注册西北地区地图数据
if (typeof window !== 'undefined') {
    window.echarts = echarts;
    echarts.registerMap('shaanxi', xianMapData);
    echarts.registerMap('gansu', gansuMapData);
    echarts.registerMap('qinghai', qinghaiMapData);
    echarts.registerMap('ningxia', ningxiaMapData);
    echarts.registerMap('xinjiang', xinjiangMapData);
}
export var MapType;
(function (MapType) {
...
// 陕西 (adcode: 610000)
export const shaanxiDistrictGeoCoordMap = {
...
export const convertShaanxiGeoData = () => shaanxiDistrictPopulationData
    .map(item => {
...
// 甘肃 (adcode: 620000)
export const gansuDistrictGeoCoordMap = {
...
export const convertGansuGeoData = () => gansuDistrictPopulationData
    .map(item => {
...
// 青海 (adcode: 630000)
export const qinghaiDistrictGeoCoordMap = {
...
export const convertQinghaiGeoData = () => qinghaiDistrictPopulationData
    .map(item => {
...
// 宁夏 (adcode: 640000)
export const ningxiaDistrictGeoCoordMap = {
...
export const convertNingxiaGeoData = () => ningxiaDistrictPopulationData
    .map(item => {
...
// 新疆 (adcode: 650000)
export const xinjiangDistrictGeoCoordMap = {
...
export const convertXinjiangGeoData = () => xinjiangDistrictPopulationData
    .map(item => {
