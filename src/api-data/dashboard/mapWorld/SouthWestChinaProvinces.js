...
import chongqingMapData from '~/geo-coordinate/500000.json';
import sichuanMapData from '~/geo-coordinate/510000.json';
import guizhouMapData from '~/geo-coordinate/520000.json';
import yunnanMapData from '~/geo-coordinate/530000.json';
import xizangMapData from '~/geo-coordinate/540000.json';
// 注册西南地区地图数据
if (typeof window !== 'undefined') {
    window.echarts = echarts;
    echarts.registerMap('chongqing', chongqingMapData);
    echarts.registerMap('sichuan', sichuanMapData);
    echarts.registerMap('guizhou', guizhouMapData);
    echarts.registerMap('yunnan', yunnanMapData);
    echarts.registerMap('xizang', xizangMapData);
}
export var MapType;
(function (MapType) {
...
// 重庆 (adcode: 500000)
export const chongqingDistrictGeoCoordMap = {
...
export const convertChongqingGeoData = () => chongqingDistrictPopulationData
    .map(item => {
...
// 四川 (adcode: 510000)
export const sichuanDistrictGeoCoordMap = {
...
export const convertSichuanGeoData = () => sichuanDistrictPopulationData
    .map(item => {
...
// 贵州 (adcode: 520000)
export const guizhouDistrictGeoCoordMap = {
...
export const convertGuizhouGeoData = () => guizhouDistrictPopulationData
    .map(item => {
...
// 云南 (adcode: 530000)
export const yunnanDistrictGeoCoordMap = {
...
export const convertYunnanGeoData = () => yunnanDistrictPopulationData
    .map(item => {
...
// 西藏 (adcode: 540000)
export const xizangDistrictGeoCoordMap = {
...
export const convertXizangGeoData = () => xizangDistrictPopulationData
    .map(item => {
