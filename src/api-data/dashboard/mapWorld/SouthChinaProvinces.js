...
import guangdongMapData from '~/geo-coordinate/440000.json';
import guangxiMapData from '~/geo-coordinate/450000.json';
import hainanMapData from '~/geo-coordinate/460000.json';
import hongkongMapData from '~/geo-coordinate/810000.json';
import aomenMapData from '~/geo-coordinate/820000.json';
// 注册华南地区地图数据
if (typeof window !== 'undefined') {
    window.echarts = echarts;
    echarts.registerMap('guangdong', guangdongMapData);
    echarts.registerMap('guangxi', guangxiMapData);
    echarts.registerMap('hainan', hainanMapData);
    echarts.registerMap('hongkong', hongkongMapData);
    echarts.registerMap('aomen', aomenMapData);
}
export var MapType;
(function (MapType) {
...
// 广东 (adcode: 440000)
export const guangdongDistrictGeoCoordMap = {
...
export const convertGuangdongGeoData = () => guangdongDistrictPopulationData
    .map(item => {
...
// 广西 (adcode: 450000)
export const guangxiDistrictGeoCoordMap = {
...
export const convertGuangxiGeoData = () => guangxiDistrictPopulationData
    .map(item => {
...
// 海南 (adcode: 460000)
export const hainanDistrictGeoCoordMap = {
...
export const convertHainanGeoData = () => hainanDistrictPopulationData
    .map(item => {
...
// 香港 (adcode: 810000)
export const hongkongDistrictGeoCoordMap = {
...
export const convertHongkongGeoData = () => hongkongDistrictPopulationData
    .map(item => {
...
// 澳门 (adcode: 820000)
export const aomenDistrictGeoCoordMap = {
...
export const convertAomenGeoData = () => aomenDistrictPopulationData
    .map(item => {
