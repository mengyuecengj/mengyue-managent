...
import henanMapData from '~/geo-coordinate/410000.json';
import hubeiMapData from '~/geo-coordinate/420000.json';
import hunanMapData from '~/geo-coordinate/430000.json';
// 注册华中地区地图数据
if (typeof window !== 'undefined') {
    window.echarts = echarts;
    echarts.registerMap('henan', henanMapData);
    echarts.registerMap('hubei', hubeiMapData);
...
// 河南 (adcode: 410000)
export const henanDistrictGeoCoordMap = {
...
export const convertHenanGeoData = () => henanDistrictPopulationData
    .map(item => {
...
// 湖北 (adcode: 420000)
export const hubeiDistrictGeoCoordMap = {
...
export const convertHubeiGeoData = () => hubeiDistrictPopulationData
    .map(item => {
...
// 湖南 (adcode: 430000)
export const hunanDistrictGeoCoordMap = {
...
export const convertHunanGeoData = () => hunanDistrictPopulationData
    .map(item => {
