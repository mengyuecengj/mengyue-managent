...
(__VLS_ctx.$t('login.leftContentA'));
var __VLS_7;
...
(__VLS_ctx.$t('login.leftContentB'));
var __VLS_11;
...
(__VLS_ctx.$t('login.leftContentC'));
var __VLS_15;
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
...
const __VLS_35 = __VLS_asFunctionalComponent(__VLS_34, new __VLS_34({
    ...{ 'onBlur': {} },
    placeholder: (__VLS_ctx.$t('login.pleaseAccount')),
    width: "100%",
    ...{ class: "form-input" },
    textColor: "#fff",
    autoComplete: "off",
...
var __VLS_49;
const __VLS_50 = {}.MYInput;
/** @type {[typeof __VLS_components.MYInput, ]} */ ;
// @ts-ignore
const __VLS_51 = __VLS_asFunctionalComponent(__VLS_50, new __VLS_50({
    ...{ 'onBlur': {} },
    placeholder: (__VLS_ctx.$t('login.pleasePassword')),
    type: "password",
    width: "100%",
    textColor: "#fff",
    ...{ class: "form-input" },
...
(__VLS_ctx.$t('login.code'));
var __VLS_65;
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "code-wrapper" },
});
const __VLS_66 = {}.MYInput;
/** @type {[typeof __VLS_components.MYInput, ]} */ ;
// @ts-ignore
const __VLS_67 = __VLS_asFunctionalComponent(__VLS_66, new __VLS_66({
    ...{ 'onKeyup': {} },
    ...{ 'onBlur': {} },
    placeholder: (__VLS_ctx.$t('login.pleaseCode')),
    width: "100%",
    ...{ class: "form-input" },
    textColor: "#fff",
