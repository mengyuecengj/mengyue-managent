...
const __VLS_19 = __VLS_asFunctionalComponent(__VLS_18, new __VLS_18({
    label: (__VLS_ctx.t('system.logininfor.loginAddress')),
    prop: "ipaddr",
}));
...
const __VLS_23 = __VLS_asFunctionalComponent(__VLS_22, new __VLS_22({
    ...
    placeholder: (__VLS_ctx.t('system.logininfor.placeholder.loginAdress')),
    clearable: true,
...
const __VLS_35 = __VLS_asFunctionalComponent(__VLS_34, new __VLS_34({
    label: (__VLS_ctx.t('system.logininfor.userName')),
    prop: "userName",
}));
...
const __VLS_39 = __VLS_asFunctionalComponent(__VLS_38, new __VLS_38({
    ...
    placeholder: (__VLS_ctx.t('system.logininfor.placeholder.userName')),
    clearable: true,
    placeholderColor: "var(--navbar-text)",
    textColor: "var(--navbar-text)",
}));
...
const __VLS_51 = __VLS_asFunctionalComponent(__VLS_50, new __VLS_50({
    label: (__VLS_ctx.t('system.logininfor.status')),
    prop: "status",
}));
...
const __VLS_55 = __VLS_asFunctionalComponent(__VLS_54, new __VLS_54({
    ...
    placeholder: (__VLS_ctx.t('system.logininfor.status')),
    clearable: true,
}));
...
(__VLS_ctx.t('system.logininfor.clean'));
var __VLS_117;
var __VLS_113;
var __VLS_97;
...
const __VLS_138 = __VLS_asFunctionalComponent(__VLS_137, new __VLS_137({
    label: (__VLS_ctx.t('system.logininfor.accessId')),
    align: "center",
    prop: "infoId",
    width: "100",
}));
...
const __VLS_150 = __VLS_asFunctionalComponent(__VLS_149, new __VLS_149({
    label: (__VLS_ctx.t('system.logininfor.loginLocation')),
    align: "center",
    prop: "loginLocation",
    width: "120",
    showOverflowTooltip: (true),
...
const __VLS_154 = __VLS_asFunctionalComponent(__VLS_153, new __VLS_153({
    label: (__VLS_ctx.t('system.logininfor.os')),
    align: "center",
    prop: "os",
    width: "120",
    showOverflowTooltip: (true),
...
const __VLS_158 = __VLS_asFunctionalComponent(__VLS_157, new __VLS_157({
    label: (__VLS_ctx.t('system.logininfor.browser')),
    align: "center",
    prop: "browser",
    width: "120",
}));
...
const __VLS_162 = __VLS_asFunctionalComponent(__VLS_161, new __VLS_161({
    label: (__VLS_ctx.t('system.logininfor.loginStatus')),
    align: "center",
    prop: "status",
    width: "100",
}));
...
const __VLS_170 = __VLS_asFunctionalComponent(__VLS_169, new __VLS_169({
    label: (__VLS_ctx.t('system.logininfor.description')),
    align: "center",
    prop: "msg",
    width: "150",
    showOverflowTooltip: (true),
...
const __VLS_174 = __VLS_asFunctionalComponent(__VLS_173, new __VLS_173({
    label: (__VLS_ctx.t('system.logininfor.accessTime')),
    align: "center",
    prop: "loginTime",
    width: "180",
    sortable: "custom",
