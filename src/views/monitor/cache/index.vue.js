...
__VLS_11.slots.default;
{
    ...
    (__VLS_ctx.t('system.cache.basicInfo'));
}
{
    ...
    (__VLS_ctx.t('system.cache.redisVersion'));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.td, __VLS_intrinsicElements.td)({
        ...{ class: "custom-cell leaf" },
    });
    ...
    (__VLS_ctx.t('system.cache.runMode'));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.td, __VLS_intrinsicElements.td)({
        ...{ class: "custom-cell leaf" },
    });
    if (__VLS_ctx.cache.info) {
        ...
        (__VLS_ctx.cache.info.redis_mode == 'standalone' ? __VLS_ctx.t('system.cache.standalone') : __VLS_ctx.t('system.cache.cluster'));
    }
    __VLS_asFunctionalElement(__VLS_intrinsicElements.td, __VLS_intrinsicElements.td)({
        ...{ class: "custom-cell leaf" },
    });
    ...
    (__VLS_ctx.t('system.cache.clientCount'));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.td, __VLS_intrinsicElements.td)({
        ...{ class: "custom-cell leaf" },
    });
    if (__VLS_ctx.cache.info) {
    ...
    (__VLS_ctx.t('system.cache.uptimeDays'));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.td, __VLS_intrinsicElements.td)({
        ...{ class: "custom-cell leaf" },
    });
    if (__VLS_ctx.cache.info) {
    ...
    (__VLS_ctx.t('system.cache.usedMemory'));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.td, __VLS_intrinsicElements.td)({
        ...{ class: "custom-cell leaf" },
    });
    if (__VLS_ctx.cache.info) {
    ...
    (__VLS_ctx.t('system.cache.usedCPU'));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.td, __VLS_intrinsicElements.td)({
        ...{ class: "custom-cell leaf" },
    });
    if (__VLS_ctx.cache.info) {
    ...
    (__VLS_ctx.t('system.cache.memoryConfig'));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.td, __VLS_intrinsicElements.td)({
        ...{ class: "custom-cell leaf" },
    });
    if (__VLS_ctx.cache.info) {
    ...
    (__VLS_ctx.t('system.cache.aofEnabled'));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.td, __VLS_intrinsicElements.td)({
        ...{ class: "custom-cell leaf" },
    });
    if (__VLS_ctx.cache.info) {
        ...
        (__VLS_ctx.cache.info.aof_enabled == '0' ? __VLS_ctx.t('system.cache.no') : __VLS_ctx.t('system.cache.yes'));
    }
    __VLS_asFunctionalElement(__VLS_intrinsicElements.td, __VLS_intrinsicElements.td)({
        ...{ class: "custom-cell leaf" },
    });
    ...
    (__VLS_ctx.t('system.cache.rdbSuccess'));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.td, __VLS_intrinsicElements.td)({
        ...{ class: "custom-cell leaf" },
    });
    if (__VLS_ctx.cache.info) {
    ...
    (__VLS_ctx.t('system.cache.keyCount'));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.td, __VLS_intrinsicElements.td)({
        ...{ class: "custom-cell leaf" },
    });
    ...
    (__VLS_ctx.t('system.cache.networkIO'));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.td, __VLS_intrinsicElements.td)({
        ...{ class: "custom-cell leaf" },
    });
    if (__VLS_ctx.cache.info) {
...
__VLS_23.slots.default;
{
    ...
    (__VLS_ctx.t('system.cache.commandStats'));
}
{
...
__VLS_35.slots.default;
{
    ...
    (__VLS_ctx.t('system.cache.memoryInfo'));
}
{
