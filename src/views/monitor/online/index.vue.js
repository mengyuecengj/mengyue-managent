...
const __VLS_19 = __VLS_asFunctionalComponent(__VLS_18, new __VLS_18({
    label: (__VLS_ctx.t('system.online.loginAddress')),
    prop: "ipaddr",
}));
...
const __VLS_23 = __VLS_asFunctionalComponent(__VLS_22, new __VLS_22({
    ...
    placeholder: (__VLS_ctx.t('system.online.loginAddressPlaceholder')),
    clearable: true,
...
const __VLS_35 = __VLS_asFunctionalComponent(__VLS_34, new __VLS_34({
    label: (__VLS_ctx.t('system.online.os')),
    prop: "os",
}));
...
const __VLS_39 = __VLS_asFunctionalComponent(__VLS_38, new __VLS_38({
    ...
    placeholder: (__VLS_ctx.t('system.online.osPlaceholder')),
    clearable: true,
    placeholderColor: "var(--navbar-text)",
    textColor: "var(--navbar-text)",
}));
...
const __VLS_83 = __VLS_asFunctionalComponent(__VLS_82, new __VLS_82({
    label: (__VLS_ctx.t('system.online.index')),
    width: "80",
    align: "center",
    prop: "index",
}));
...
const __VLS_87 = __VLS_asFunctionalComponent(__VLS_86, new __VLS_86({
    label: (__VLS_ctx.t('system.online.tokenId')),
    align: "center",
    prop: "tokenId",
...
const __VLS_91 = __VLS_asFunctionalComponent(__VLS_90, new __VLS_90({
    label: (__VLS_ctx.t('system.online.userName')),
    align: "center",
    prop: "userName",
    showOverflowTooltip: (true),
}));
...
const __VLS_95 = __VLS_asFunctionalComponent(__VLS_94, new __VLS_94({
    label: (__VLS_ctx.t('system.online.deptName')),
    align: "center",
    prop: "deptName",
    showOverflowTooltip: (true),
}));
...
const __VLS_99 = __VLS_asFunctionalComponent(__VLS_98, new __VLS_98({
    label: (__VLS_ctx.t('system.online.host')),
    align: "center",
    prop: "ipaddr",
    showOverflowTooltip: (true),
}));
...
const __VLS_103 = __VLS_asFunctionalComponent(__VLS_102, new __VLS_102({
    label: (__VLS_ctx.t('system.online.loginLocation')),
    align: "center",
    prop: "loginLocation",
    showOverflowTooltip: (true),
}));
...
const __VLS_111 = __VLS_asFunctionalComponent(__VLS_110, new __VLS_110({
    label: (__VLS_ctx.t('system.online.browser')),
    align: "center",
    prop: "browser",
    showOverflowTooltip: (true),
}));
...
const __VLS_115 = __VLS_asFunctionalComponent(__VLS_114, new __VLS_114({
    label: (__VLS_ctx.t('system.online.loginTime')),
    align: "center",
    prop: "loginTime",
    sortable: "180",
}));
...
const __VLS_119 = __VLS_asFunctionalComponent(__VLS_118, new __VLS_118({
    label: (__VLS_ctx.t('system.online.operation')),
    align: "center",
    prop: "operation",
...
}, ...__VLS_functionalComponentArgsRest(__VLS_119));
{
    ...
    (__VLS_ctx.t('system.online.forceLogout'));
    var __VLS_125;
}
var __VLS_81;
