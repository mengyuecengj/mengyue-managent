import { apiServer } from '@/api-data/monitor/serverApi';
import { useApiDocumentation } from '@/hooks/useApiDocumentation';
const { searchKeyword, filterMethod, selectedApi, filteredApis, getMethodType, selectApi, resetQuery, generateRequestExample, generateResponseExample } = useApiDocumentation(apiServer);
...
(__VLS_ctx.$t('apiReferenceModules.server.title'));
var __VLS_3;
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "search-box" },
});
