...
// 🔥 封装翻译方法（核心优化点）
const tCommon = (key) => t(`apiReferenceCommon.${key}`);
const tModule = (key) => t(`apiReferenceModules.${module}.${key}`);
...
const { searchKeyword, filterMethod, selectedApi, filteredApis, getMethodType, selectApi, resetQuery, generateRequestExample, generateResponseExample } = useApiDocumentation(apiUser);
...
const __VLS_5 = __VLS_asFunctionalComponent(__VLS_4, new __VLS_4({
    ...
    placeholder: (__VLS_ctx.tCommon('searchPlaceholder')),
    clearable: true,
    prefixIcon: "Search",
    ...{ style: {} },
...
const __VLS_9 = __VLS_asFunctionalComponent(__VLS_8, new __VLS_8({
    ...
    placeholder: (__VLS_ctx.tCommon('filterMethodPlaceholder')),
    clearable: true,
}));
...
(__VLS_ctx.tCommon('sidebarHeader'));
var __VLS_43;
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "api-items" },
});
for (const [api] of __VLS_getVForSourceType((__VLS_ctx.filteredApis))) {
    ...
    (__VLS_ctx.getDesc(api.description));
    if (api.requiresAuth) {
        ...
        (__VLS_ctx.tCommon('authRequired'));
        var __VLS_47;
    }
}
var __VLS_39;
...
if (__VLS_ctx.selectedApi) {
    ...
    (__VLS_ctx.getDesc(__VLS_ctx.selectedApi.description));
    ...
    (__VLS_ctx.tCommon('tableProperty'));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...{ class: "table-cell-value" },
    });
    (__VLS_ctx.tCommon('tableValue'));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...{ class: "table-row" },
    });
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...
    (__VLS_ctx.tCommon('interfaceDesc'));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...{ class: "table-cell value" },
    });
    (__VLS_ctx.getDesc(__VLS_ctx.selectedApi.description));
    ...
    (__VLS_ctx.tCommon('requestMethod'));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...{ class: "table-cell value" },
    });
    ...
    (__VLS_ctx.tCommon('interfacePath'));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...{ class: "table-cell value" },
    });
    __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({
    ...
    (__VLS_ctx.tCommon('authRequirement'));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...{ class: "table-cell value" },
    });
    __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({
    ...
    (__VLS_ctx.selectedApi.requiresAuth
        ? __VLS_ctx.tCommon('requiresAuth')
        : __VLS_ctx.tCommon('noAuth'));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...{ class: "detail-section" },
    });
    ...
    (__VLS_ctx.tCommon('responseExample'));
    var __VLS_59;
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...{ class: "code-block" },
    });
    ...
    if (__VLS_ctx.selectedApi.errorResponse) {
        ...
        (__VLS_ctx.tCommon('errorResponseExample'));
        var __VLS_67;
        __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
            ...{ class: "code-block" },
        });
