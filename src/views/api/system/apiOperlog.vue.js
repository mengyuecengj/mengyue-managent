import { apiOperlog } from '@/api-data/system/operlogApi';
import { useApiDocumentation } from '@/hooks/useApiDocumentation';
const { searchKeyword, filterMethod, selectedApi, filteredApis, getMethodType, selectApi, resetQuery, generateRequestExample, generateResponseExample } = useApiDocumentation(apiOperlog);
...
(__VLS_ctx.$t('apiReferenceModules.operlog.title'));
var __VLS_3;
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "search-box" },
});
