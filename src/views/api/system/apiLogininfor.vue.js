import { apiLogininfor } from '@/api-data/system/logininforApi';
import { useApiDocumentation } from '@/hooks/useApiDocumentation';
const { searchKeyword, filterMethod, selectedApi, filteredApis, getMethodType, selectApi, resetQuery, generateRequestExample, generateResponseExample } = useApiDocumentation(apiLogininfor);
...
(__VLS_ctx.$t('apiReferenceModules.logininfor.title'));
var __VLS_3;
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "search-box" },
});
...
const __VLS_5 = __VLS_asFunctionalComponent(__VLS_4, new __VLS_4({
    ...
    placeholder: (__VLS_ctx.$t('apiReferenceCommon.searchPlaceholder')),
    clearable: true,
    prefixIcon: "Search",
    ...{ style: {} },
...
const __VLS_9 = __VLS_asFunctionalComponent(__VLS_8, new __VLS_8({
    ...
    placeholder: (__VLS_ctx.$t('apiReferenceCommon.filterMethodPlaceholder')),
    clearable: true,
}));
...
(__VLS_ctx.$t('apiReferenceCommon.resetButton'));
var __VLS_31;
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
...
(__VLS_ctx.$t('apiReferenceCommon.sidebarHeader'));
var __VLS_43;
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "api-items" },
});
for (const [api] of __VLS_getVForSourceType((__VLS_ctx.filteredApis))) {
    ...
    if (api.requiresAuth) {
        ...
        (__VLS_ctx.$t('apiReferenceCommon.authRequired'));
        var __VLS_47;
    }
}
var __VLS_39;
...
if (__VLS_ctx.selectedApi) {
    ...
    (__VLS_ctx.$t('apiReferenceCommon.basicInfo'));
    var __VLS_55;
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...{ class: "custom-table" },
    });
    ...
    (__VLS_ctx.$t('apiReferenceCommon.tableProperty'));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...{ class: "table-cell-value" },
    });
    (__VLS_ctx.$t('apiReferenceCommon.tableValue'));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...{ class: "table-row" },
    });
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...
    (__VLS_ctx.$t('apiReferenceCommon.interfaceDesc'));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...{ class: "table-cell value" },
    });
    (__VLS_ctx.selectedApi.description);
    ...
    (__VLS_ctx.$t('apiReferenceCommon.requestMethod'));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...{ class: "table-cell value" },
    });
    ...
    (__VLS_ctx.$t('apiReferenceCommon.interfacePath'));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...{ class: "table-cell value" },
    });
    __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({
    ...
    (__VLS_ctx.$t('apiReferenceCommon.authRequirement'));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...{ class: "table-cell value" },
    });
    __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({
    ...
    (__VLS_ctx.selectedApi.requiresAuth
        ? __VLS_ctx.$t('apiReferenceCommon.requiresAuth')
        : __VLS_ctx.$t('apiReferenceCommon.noAuth'));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...{ class: "detail-section" },
    });
    ...
    (__VLS_ctx.$t('apiReferenceCommon.responseExample'));
    var __VLS_59;
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...{ class: "code-block" },
    });
    ...
    (__VLS_ctx.$t('apiReferenceCommon.callExample'));
    var __VLS_63;
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...{ class: "code-block" },
    });
    ...
    if (__VLS_ctx.selectedApi.errorResponse) {
        ...
        (__VLS_ctx.$t('apiReferenceCommon.errorResponseExample'));
        var __VLS_67;
        __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
            ...{ class: "code-block" },
        });
