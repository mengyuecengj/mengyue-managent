import { apiDict } from '@/api-data/system/dictApi';
import { useApiDocumentation } from '@/hooks/useApiDocumentation';
const { searchKeyword, filterMethod, selectedApi, filteredApis, getMethodType, selectApi, resetQuery, generateRequestExample, generateResponseExample } = useApiDocumentation(apiDict);
...
(__VLS_ctx.$t('apiReferenceModules.dict.title'));
var __VLS_3;
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "search-box" },
});
