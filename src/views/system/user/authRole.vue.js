...
(__VLS_ctx.t('system.user.authRole.basicInfo'));
...
const __VLS_13 = __VLS_asFunctionalComponent(__VLS_12, new __VLS_12({
    label: (__VLS_ctx.t('system.user.authRole.form.nickName')),
    prop: "nickName",
}));
...
const __VLS_25 = __VLS_asFunctionalComponent(__VLS_24, new __VLS_24({
    label: (__VLS_ctx.t('system.user.authRole.form.userName')),
    prop: "userName",
}));
...
(__VLS_ctx.t('system.user.authRole.roleInfo'));
...
const __VLS_43 = __VLS_asFunctionalComponent(__VLS_42, new __VLS_42({
    label: (__VLS_ctx.t('system.user.authRole.table.index')),
    width: "55",
    type: "index",
    align: "center",
}));
...
const __VLS_51 = __VLS_asFunctionalComponent(__VLS_50, new __VLS_50({
    label: (__VLS_ctx.t('system.user.authRole.table.roleId')),
    align: "center",
    prop: "roleId",
}));
...
const __VLS_55 = __VLS_asFunctionalComponent(__VLS_54, new __VLS_54({
    label: (__VLS_ctx.t('system.user.authRole.table.roleName')),
    align: "center",
    prop: "roleName",
}));
...
const __VLS_59 = __VLS_asFunctionalComponent(__VLS_58, new __VLS_58({
    label: (__VLS_ctx.t('system.user.authRole.table.roleKey')),
    align: "center",
    prop: "roleKey",
}));
...
const __VLS_63 = __VLS_asFunctionalComponent(__VLS_62, new __VLS_62({
    label: (__VLS_ctx.t('system.user.authRole.table.createTime')),
    align: "center",
    prop: "createTime",
    width: "180",
}));
...
(__VLS_ctx.t('system.user.authRole.button.submit'));
var __VLS_73;
...
(__VLS_ctx.t('system.user.authRole.button.back'));
var __VLS_81;
