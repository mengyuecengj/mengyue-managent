...
__VLS_asFunctionalElement(__VLS_intrinsicElements.img)({
    ...
    title: (__VLS_ctx.$t('system.user.profile.avatar.uploadTip')),
...
const __VLS_1 = __VLS_asFunctionalComponent(__VLS_0, new __VLS_0({
    title: (__VLS_ctx.$t('system.user.profile.avatar.title')),
...
(__VLS_ctx.$t('system.user.profile.avatar.uploadBtn'));
var __VLS_7;
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "action" },
});
...
(__VLS_ctx.$t('system.user.profile.avatar.zoomIn'));
var __VLS_15;
...
(__VLS_ctx.$t('system.user.profile.avatar.zoomOut'));
var __VLS_23;
...
(__VLS_ctx.$t('system.user.profile.avatar.rotateRight'));
var __VLS_31;
...
(__VLS_ctx.$t('system.user.profile.avatar.rotateLeft'));
var __VLS_39;
...
(__VLS_ctx.$t('system.user.profile.avatar.submit'));
var __VLS_47;
var __VLS_3;
/** @type {__VLS_StyleScopedClasses['user-info-head']} */ ;
