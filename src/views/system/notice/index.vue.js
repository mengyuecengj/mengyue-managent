...
const __VLS_19 = __VLS_asFunctionalComponent(__VLS_18, new __VLS_18({
    label: (__VLS_ctx.t('system.notice.noticeTitle')),
    prop: "configName",
}));
...
const __VLS_23 = __VLS_asFunctionalComponent(__VLS_22, new __VLS_22({
    ...
    label: (__VLS_ctx.t('system.notice.placeholder.placeholderNoticeTitle')),
    clearable: true,
...
const __VLS_31 = __VLS_asFunctionalComponent(__VLS_30, new __VLS_30({
    label: (__VLS_ctx.t('system.notice.noticeActions')),
    prop: "createBy",
}));
...
const __VLS_35 = __VLS_asFunctionalComponent(__VLS_34, new __VLS_34({
    ...
    label: (__VLS_ctx.t('system.notice.placeholder.placeholderNoticeActions')),
    clearable: true,
    placeholderColor: "var(--navbar-text)",
    textColor: "var(--navbar-text)",
}));
...
const __VLS_43 = __VLS_asFunctionalComponent(__VLS_42, new __VLS_42({
    label: (__VLS_ctx.t('system.notice.type')),
    prop: "noticeType",
}));
...
const __VLS_47 = __VLS_asFunctionalComponent(__VLS_46, new __VLS_46({
    ...
    label: (__VLS_ctx.t('system.notice.placeholder.placeholderType')),
    clearable: true,
    ...{ style: {} },
}));
...
(__VLS_ctx.t('system.dict.refreshCache'));
var __VLS_133;
var __VLS_129;
var __VLS_89;
...
const __VLS_152 = __VLS_asFunctionalComponent(__VLS_151, new __VLS_151({
    label: (__VLS_ctx.t('system.notice.id')),
    prop: "noticeId",
    width: "120",
}));
...
const __VLS_168 = __VLS_asFunctionalComponent(__VLS_167, new __VLS_167({
    label: (__VLS_ctx.t('system.notice.status')),
    align: "center",
    width: "100",
    prop: "type",
}));
...
const __VLS_176 = __VLS_asFunctionalComponent(__VLS_175, new __VLS_175({
    label: (__VLS_ctx.t('system.notice.created')),
    prop: "createBy",
    showOverflowTooltip: (true),
}));
...
const __VLS_246 = __VLS_asFunctionalComponent(__VLS_245, new __VLS_245({
    ...
    label: (__VLS_ctx.t('system.notice.placeholder.placeholderNoticeType')),
    clearable: true,
}));
